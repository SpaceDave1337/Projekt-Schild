...
public class DSCModelProvider extends FabricModelProvider {
    ...
    private static final Model BASIC_ALIGN_MODEL = new Model(
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        for (Block block : DSCBlocks.basicBlocks){
            registerCustomBlockWithTextures(blockStateModelGenerator, block);
        }
    }
    ...
    private void registerCustomBlockWithTextures(BlockStateModelGenerator blockStateModelGenerator, Block block) {      //shout out to https://github.com/O7410
        ...
        BASIC_ALIGN_MODEL.upload(block, new TextureMap()
